        ...
        <Container size="3" px={{ initial: "4", sm: "6" }}>
          <Testimonial.Root py={{ initial: "4", sm: "6" }} align="start">
            <Testimonial.Quote size={{ initial: "6", sm: "7", lg: "8" }} align="left">
              Kookie Blocks takes the foundations of Kookie UI and turns them into ready-to-use building blocks. Instead of assembling components from scratch every time, we now have powerful, composable patterns that just work. It's going to change how we build interfaces.
            </Testimonial.Quote>
