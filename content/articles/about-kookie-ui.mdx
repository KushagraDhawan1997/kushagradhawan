...
KookieUI started as my personal project. As I worked on it, I realized I could use it for Womp to solve real problems.
...
- **Clear ownership.** Through KookieUI, design controls the design layer. If something looks wrong, the system needs to encode it. That responsibility belongs to me as the consulting design lead. Engineers implement design from the system. This creates clarity.
