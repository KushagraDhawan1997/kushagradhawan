...
I built Chatbar while working on Womp Spark, Womp's AI assistant. The product needed a consistent input experience across desktop and mobile, with file attachments, stop/regenerate actions, and smooth keyboard interaction.
