...
date: "2025-12-14"
published: true
image: "/articles/on-ai/image.jpg"
...
In client work, this changes how products get built. Features that would've needed careful planning and specialist developers can now be sketched out, tested with users, and iterated on before committing to a full implementation. The feedback loop is tighter.
